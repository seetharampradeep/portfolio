...
import img from "../Assests/Profile_pic_edited-removebg-preview.png"
    ...
    <section className="home-section d-flex align-items-center">
      <div className="container-fluid">
        <div className="row align-items-center min-vh-100">
          <div className="col-lg-6 col-md-12 home-content text-center text-lg-start px-5">
          ...
          <div className="col-lg-6 col-md-12 home-image p-0">
            <img
              src={img}
              alt="Profile"
